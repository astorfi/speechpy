...
latex_documents = [(master_doc, "test.tex", u"test Documentation", u"test", "manual")]
...
#  author, documentclass [howto, manual, or own class]).
latex_documents = [
    (master_doc, "speechpy.tex", "SpeechPy Documentation", "Amirsina Torfi", "manual")
]
...
man_pages = [(master_doc, "speechpy", u"SpeechPy Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "SpeechPy",
        u"SpeechPy Documentation",
        author,
        "SpeechPy",
        "A library for Speech Recognition and Feature Extraction.",
        "Miscellaneous",
    )
]
